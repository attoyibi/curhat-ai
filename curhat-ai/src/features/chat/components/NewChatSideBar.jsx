...
import useChatWithRedux from "../hooks/useChatWithRedux"; // Import the useChat hook
...
export function NewChatSideBar() {
  ...
  const handleKeyDown = (e) => {
    if (e.key === "Enter" && !e.shiftKey) {
      ...
      handleChatMessage(); // Call send message function
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto ">
      ...
      {/* chat area */}
      <div className=" bg-white fixed bottom-0 w-full z-10 max-w-3xl p-2">
